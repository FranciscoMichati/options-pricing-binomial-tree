...
# 'lite' tree mode
option_lite_tree = BinomialOptionTree('full', option_excercise_type = excercise_type, option_type = type, position = position, n = n, volatility = volatility, r = r, delta = delta, k = k, s = s)
option_lite_tree.return_tree()
print(f'Valuation day option price using full tree: {option_lite_tree.option_price}')